"""
Скрипт для анализа качества предсказаний TFT модели.
Вычисляет метрики и строит визуализации.
"""
...
# Загрузка предсказаний и реальных значений
pred = np.load("data/predictions.npy")
data = np.load("data/train_test.npz")
y_test = data["y_test"]

# Вычисляем направление: Up (+1), Down (-1), Neutral (0)
...
# ============ График 4: Confusion Matrix направлений ============
ax4 = axes[1, 1]
...
# Метрики по шагам (если есть несколько шагов предсказания)
print("\n" + "=" * 50)
